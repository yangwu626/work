...
<?php 
    ...
    echo "<h3>" . $menuItem1->getItemName() . "</h3>";
    echo "<p>"  . $menuItem1->getDescription() . " - $" . $menuItem1->getPrice() . "</p>";
?>
...
<?php 
    ...
    echo "<h3>" . $menuItem2->getItemName() . "</h3>";
    echo "<p>"  . $menuItem2->getDescription() . " - $" . $menuItem2->getPrice() . "</p>";
?>
